...
# Histórias de Usuário
 ...
 - **HU11** Como comprador quero realizar o pagamento em duas etapas para garantir a entrega do produto
 - **HU12** Como vendedor quero receber meu dinheiro após a entrega do produto
 - **HU13** Como comprador quero receber um comprovante do meu pagamento para ter a garantia da minha transferência
 - **HU14** Como usuário quero cadastrar as minhas informações bancárias 
 - **HU15** Como comprador quero poder escolher diferentes formas de pagamento
 - **HU16** Como vendedor quero que meus produtos cadastrados sejam exibidos pelo sistema
 - **HU17** Como usuário quero poder navegar entre as páginas para descobrir os produtos
 - **HU18** Como vendedor quero acessar minhas vendas para administração
 - **HU19** Como usuário quero poder pesquisar por produtos para facilitar minha busca
 - **HU20** Como usuário quero poder adicionar produtos ao carrinho de compras para comprar futuramente
 - **HU21** Como comprador quero visualizar meu histórico de compras
 - **HU22** Como comprador quero poder visualizar mais detalhes sobre o produto para entender mais sobre o produto
 - **HU23** Como usuário quero poder filtrar produtos por categoria para facilitar minha busca
 - **HU24** Como usuário quero poder ver as avaliações dos produtos para identificar produtos com melhores avaliações
 - **HU25** Como usuário quero poder filtrar produtos no meu histórico de compras
 - **HU26** Como vendedor quero poder cadastrar meus produtos com detalhes e imagens para realizar vendas
 - **HU27** Como vendedor quero poder editar as informações de um produto cadastrado para manter as informações atualizadas
 - **HU28** Como vendedor quero poder deletar um produto cadastrado para manter meu catálogo limpo e atualizado
 - **HU29** Como comprador quero poder avaliar produtos já comprado para ajudar outros usuário
 - **HU30** Como comprador quero poder cancelar compras não finalizadas que não desejo comprar mais
 - **HU31** Como vendedor quero poder cancelar produtos não finalizadas que não desejo desenvolver mais
 - **HU32** Como usuário quero receber notificações sobre cancelamentos
